...
public class Soul : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("Velocidad de aproximaci�n hacia el jugador")]
    ...
    // VARIABLES
    private Vector3 _playerPosition; // Direcci�n hacia la que se va a dirigir
    ...
    {
        // Cogemos el vector direcci�n como magnitud
        Vector2 dir = direction.normalized;
        // Y lo movemos (a mayor distancia, m�s lentitud de acercamiento)
